  ...
  //crush//
    ...
    else if (crushLowerCase == "no" || crushLowerCase == "n") {alert ("You're totally wrong right now.");
...
//mona//
    ...
    else if (monaLowerCase == "no" || monaLowerCase == "n") {alert ("You would think that. Classic " +userName + ". Smarty Pants.");
    console.log("user responded no to question three.")
    }
    else {alert ("Yes or no answers only, please.")
    }
  //age//
    ...
    else if (age >= 88) {alert ("Don't be rude. She's not dead. Your guess is too high!")
    }
